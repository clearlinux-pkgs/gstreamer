...
Source0  : https://gstreamer.freedesktop.org/src/gstreamer/gstreamer-1.24.11.tar.xz
Source1  : https://gstreamer.freedesktop.org/src/gstreamer/gstreamer-1.24.11.tar.xz.asc
...
%setup -q -n gstreamer-1.24.11
cd %{_builddir}/gstreamer-1.24.11
pushd ..
cp -a gstreamer-1.24.11 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1736270763
...
/usr/share/gdb/auto-load/usr/lib64/libgstreamer-1.0.so.0.2411.0-gdb.py
...
/V3/usr/lib64/libgstbase-1.0.so.0.2411.0
/V3/usr/lib64/libgstcheck-1.0.so.0.2411.0
/V3/usr/lib64/libgstcontroller-1.0.so.0.2411.0
/V3/usr/lib64/libgstnet-1.0.so.0.2411.0
/V3/usr/lib64/libgstreamer-1.0.so.0.2411.0
/usr/lib64/gstreamer-1.0/libgstcoreelements.so
/usr/lib64/gstreamer-1.0/libgstcoretracers.so
/usr/lib64/libgstbase-1.0.so.0
/usr/lib64/libgstbase-1.0.so.0.2411.0
/usr/lib64/libgstcheck-1.0.so.0
/usr/lib64/libgstcheck-1.0.so.0.2411.0
/usr/lib64/libgstcontroller-1.0.so.0
/usr/lib64/libgstcontroller-1.0.so.0.2411.0
/usr/lib64/libgstnet-1.0.so.0
/usr/lib64/libgstnet-1.0.so.0.2411.0
/usr/lib64/libgstreamer-1.0.so.0
/usr/lib64/libgstreamer-1.0.so.0.2411.0
