...
Source0  : https://gstreamer.freedesktop.org/src/gstreamer/gstreamer-1.24.1.tar.xz
Source1  : https://gstreamer.freedesktop.org/src/gstreamer/gstreamer-1.24.1.tar.xz.asc
...
%prep
%setup -q -n gstreamer-1.24.1
cd %{_builddir}/gstreamer-1.24.1
pushd ..
cp -a gstreamer-1.24.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1711237319
...
/usr/share/gdb/auto-load/usr/lib64/libgstreamer-1.0.so.0.2401.0-gdb.py
...
/V3/usr/lib64/libgstbase-1.0.so.0.2401.0
/V3/usr/lib64/libgstcheck-1.0.so.0.2401.0
/V3/usr/lib64/libgstcontroller-1.0.so.0.2401.0
/V3/usr/lib64/libgstnet-1.0.so.0.2401.0
/V3/usr/lib64/libgstreamer-1.0.so.0.2401.0
/usr/lib64/gstreamer-1.0/libgstcoreelements.so
/usr/lib64/gstreamer-1.0/libgstcoretracers.so
/usr/lib64/libgstbase-1.0.so.0
/usr/lib64/libgstbase-1.0.so.0.2401.0
/usr/lib64/libgstcheck-1.0.so.0
/usr/lib64/libgstcheck-1.0.so.0.2401.0
/usr/lib64/libgstcontroller-1.0.so.0
/usr/lib64/libgstcontroller-1.0.so.0.2401.0
/usr/lib64/libgstnet-1.0.so.0
/usr/lib64/libgstnet-1.0.so.0.2401.0
/usr/lib64/libgstreamer-1.0.so.0
/usr/lib64/libgstreamer-1.0.so.0.2401.0
